"""
This implementation of ResNet is derived from https://www.youtube.com/watch?v=DkNIBBBvcPs
"""
...
class Bottleneck(nn.Module):
    def __init__(self, in_channels, mid_channels, identity_downsample=None, stride=1):
        ...
        * mid_channels: number of channels for depthwise separable convolution
        ...
        * stride: stride of the convolutinonal layer of the main path
        ...
        self.bn3 = nn.BatchNorm2d(
            num_features=mid_channels*self.expansion
        )
...
class ResNet(nn.Module):
    def __init__(
        ...
        * num_classes: number of classes to predict
        ...
        self.layer1 = self._make_layer(
            block, layers[0], mid_channels=64, stride=1
        )
        self.layer2 = self._make_layer(
            block, layers[1], mid_channels=128, stride=2
        )
        self.layer3 = self._make_layer(
            block, layers[2], mid_channels=256, stride=2
        )
        self.layer4 = self._make_layer(
            block, layers[3], mid_channels=512, stride=2
        )
    ...
    def _make_layer(self, block, n_blocks, mid_channels, stride):
        """
